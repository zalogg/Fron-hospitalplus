...
const Clsrental = () => {
    ...
    const fetchServiceData = () => {
        fetch(process.env.REACT_APP_GET_SERVICES + "/" + idservices)
    ...
    const fetchReservations = () => {
        fetch(process.env.REACT_APP_CREATE_RESERVE + "/" + idclients)
            .then((response) => response.json())
    ...
    const sendData = async () => {
        ...
        const url1 = process.env.REACT_APP_CREATE_SERVICERENT;
            ...
            <section className="main-content">
                <div className="row max-inner">
                    <div className="columns col-4 product-media">
                        <img src={'${process.env.REACT_APP_GET_IMAGES}/' + name} className="hall-image" alt={name} />
                    </div>
